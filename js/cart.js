    ...
    if(cart.length>0){
            ...
            cartOverview.innerHTML += `
                <div class="selected-game" id="${id}-wrapper">
                    ...
                    <div class="selected-game__content">
                        ...
                        <p class="game-condition">Condition: ${condition}</p>
                    </div>
        ...
        removeButtons.forEach(btn => {
            btn.onclick = function(){
                ...
                const removedTitle = checkUndefined(productToRemove.title, " game");
                const updatedCart = getCart().filter(prod => prod.id !== productToRemoveId);
